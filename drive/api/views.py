...
class DriveSettingsView(APIView):
    ...
    def get(self, request):
        drive_settings = request.user.drive_settings
        serializer = DriveSettingsSerializer(drive_settings, many=False, read_only=True)
        return Response(serializer.data)

class ClassifiedFilesView(APIView):
